...
namespace webMVC.Controllers
{
    public class clienteController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/ClientesApellido/{apellido}")]
        public IQueryable<tb_cliente> GetClienteApellido(string apellido)
        {
            return db.tb_cliente.Where(b => b.Apellidos.Contains(apellido));
        }
